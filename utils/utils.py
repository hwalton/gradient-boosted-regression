...
def load_processed_data(processed_dir: str = "data/processed") -> Tuple[pd.DataFrame, pd.DataFrame, pd.Series, pd.Series]:
    """
    Load processed train/test CSVs from processed_dir and return:
